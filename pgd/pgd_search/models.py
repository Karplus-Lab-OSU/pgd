...
class Search_residue(models.Model):
    ...
    #sidechain angles includes
    CA_CB_CG_include        = models.NullBooleanField(null=True)
    CA_CB_CG1_include       = models.NullBooleanField(null=True)
    CA_CB_CG2_include       = models.NullBooleanField(null=True)
    CA_CB_OG_include        = models.NullBooleanField(null=True)
    CA_CB_OG1_include       = models.NullBooleanField(null=True)
    CA_CB_SG_include        = models.NullBooleanField(null=True)
    CB_CG1_CD1_include      = models.NullBooleanField(null=True)
    CB_CG_CD_include        = models.NullBooleanField(null=True)
    CB_CG_CD1_include       = models.NullBooleanField(null=True)
    CB_CG_CD2_include       = models.NullBooleanField(null=True)
    CB_CG_ND1_include       = models.NullBooleanField(null=True)
    CB_CG_ND2_include       = models.NullBooleanField(null=True)
    CB_CG_OD1_include       = models.NullBooleanField(null=True)
    CB_CG_OD2_include       = models.NullBooleanField(null=True)
    CB_CG_SD_include        = models.NullBooleanField(null=True)
    CD1_CG_CD2_include      = models.NullBooleanField(null=True)
    CD1_NE1_CE2_include     = models.NullBooleanField(null=True)
    CD2_CE2_CZ2_include     = models.NullBooleanField(null=True)
    CD2_CE3_CZ3_include     = models.NullBooleanField(null=True)
    CD2_CG_CD1_include      = models.NullBooleanField(null=True)
    CD_CE_NZ_include        = models.NullBooleanField(null=True)
    CD_NE_CZ_include        = models.NullBooleanField(null=True)
    CD_N_CA_include         = models.NullBooleanField(null=True)
    CE1_CZ_CE2_include      = models.NullBooleanField(null=True)
    CE1_CZ_OH_include       = models.NullBooleanField(null=True)
    CE1_NE2_CD2_include     = models.NullBooleanField(null=True)
    CE2_CD2_CE3_include     = models.NullBooleanField(null=True)
    CE2_CZ2_CH2_include     = models.NullBooleanField(null=True)
    CE2_CZ_OH_include       = models.NullBooleanField(null=True)
    CE3_CZ3_CH2_include     = models.NullBooleanField(null=True)
    CG1_CB_CG2_include      = models.NullBooleanField(null=True)
    CG_CD1_CE1_include      = models.NullBooleanField(null=True)
    CG_CD1_NE1_include      = models.NullBooleanField(null=True)
    CG_CD2_CE2_include      = models.NullBooleanField(null=True)
    CG_CD2_CE3_include      = models.NullBooleanField(null=True)
    CG_CD2_NE2_include      = models.NullBooleanField(null=True)
    CG_CD_CE_include        = models.NullBooleanField(null=True)
    CG_CD_N_include         = models.NullBooleanField(null=True)
    CG_CD_NE_include        = models.NullBooleanField(null=True)
    CG_CD_NE2_include       = models.NullBooleanField(null=True)
    CG_CD_OE1_include       = models.NullBooleanField(null=True)
    CG_CD_OE2_include       = models.NullBooleanField(null=True)
    CG_ND1_CE1_include      = models.NullBooleanField(null=True)
    CG_SD_CE_include        = models.NullBooleanField(null=True)
    CZ2_CH2_CZ3_include     = models.NullBooleanField(null=True)
    CZ_CE1_CD1_include      = models.NullBooleanField(null=True)
    CZ_CE2_CD2_include      = models.NullBooleanField(null=True)
    ND1_CE1_NE2_include     = models.NullBooleanField(null=True)
    ND1_CG_CD2_include      = models.NullBooleanField(null=True)
    NE1_CE2_CD2_include     = models.NullBooleanField(null=True)
    NE1_CE2_CZ2_include     = models.NullBooleanField(null=True)
    NE_CZ_NH1_include       = models.NullBooleanField(null=True)
    NE_CZ_NH2_include       = models.NullBooleanField(null=True)
    NH1_CZ_NH2_include      = models.NullBooleanField(null=True)
    OD1_CG_ND2_include      = models.NullBooleanField(null=True)
    OD1_CG_OD2_include      = models.NullBooleanField(null=True)
    OE1_CD_NE2_include      = models.NullBooleanField(null=True)
    OE1_CD_OE2_include      = models.NullBooleanField(null=True)
    OG1_CB_CG2_include      = models.NullBooleanField(null=True)

    #sidechain lengths includes
    CB_CG_include           = models.NullBooleanField(null=True)
    CB_CG1_include          = models.NullBooleanField(null=True)
    CB_CG2_include          = models.NullBooleanField(null=True)
    CB_OG_include           = models.NullBooleanField(null=True)
    CB_OG1_include          = models.NullBooleanField(null=True)
    CB_SG_include           = models.NullBooleanField(null=True)
    CD1_CE1_include         = models.NullBooleanField(null=True)
    CD1_NE1_include         = models.NullBooleanField(null=True)
    CD2_CE2_include         = models.NullBooleanField(null=True)
    CD2_CE3_include         = models.NullBooleanField(null=True)
    CD_CE_include           = models.NullBooleanField(null=True)
    CD_N_include            = models.NullBooleanField(null=True)
    CD_NE_include           = models.NullBooleanField(null=True)
    CD_NE2_include          = models.NullBooleanField(null=True)
    CD_OE1_include          = models.NullBooleanField(null=True)
    CD_OE2_include          = models.NullBooleanField(null=True)
    CE1_NE2_include         = models.NullBooleanField(null=True)
    CE2_CZ2_include         = models.NullBooleanField(null=True)
    CE_NZ_include           = models.NullBooleanField(null=True)
    CG1_CD1_include         = models.NullBooleanField(null=True)
    CG_CD_include           = models.NullBooleanField(null=True)
    CG_CD1_include          = models.NullBooleanField(null=True)
    CG_CD2_include          = models.NullBooleanField(null=True)
    CG_ND1_include          = models.NullBooleanField(null=True)
    CG_ND2_include          = models.NullBooleanField(null=True)
    CG_OD1_include          = models.NullBooleanField(null=True)
    CG_OD2_include          = models.NullBooleanField(null=True)
    CG_SD_include           = models.NullBooleanField(null=True)
    CH2_CZ3_include         = models.NullBooleanField(null=True)
    CZ2_CH2_include         = models.NullBooleanField(null=True)
    CZ3_CE3_include         = models.NullBooleanField(null=True)
    CZ_CE1_include          = models.NullBooleanField(null=True)
    CZ_CE2_include          = models.NullBooleanField(null=True)
    CZ_NH1_include          = models.NullBooleanField(null=True)
    CZ_NH2_include          = models.NullBooleanField(null=True)
    CZ_OH_include           = models.NullBooleanField(null=True)
    ND1_CE1_include         = models.NullBooleanField(null=True)
    NE1_CE2_include         = models.NullBooleanField(null=True)
    NE2_CD2_include         = models.NullBooleanField(null=True)
    NE_CZ_include           = models.NullBooleanField(null=True)
    SD_CE_include           = models.NullBooleanField(null=True)
