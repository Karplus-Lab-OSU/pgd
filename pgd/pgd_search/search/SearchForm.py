...
class SearchFormBase(forms.Form):
    ...
    rfactorMax      = forms.FloatField(required=False, min_value=0, initial=0.4, widget=forms.TextInput(attrs={'size':3}))
    rfreeMin        = forms.FloatField(required=False, min_value=0, initial=0, widget=forms.TextInput(attrs={'size':3}))
    rfreeMax        = forms.FloatField(required=False, min_value=0, initial=0.4, widget=forms.TextInput(attrs={'size':3}))
