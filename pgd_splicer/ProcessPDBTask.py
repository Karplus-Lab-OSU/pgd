...
class OccupancySelect(Select):
    ...
    def accept_residue(self, residue):
        """
        This method is being overloaded to perform the calculations required to properly accept atoms in the model based on the highest average occupancy value per altloc.
        """
    ...
    def accept_atom(self, atom):
        """
        This method uses the information generated by accept_residue and stored in best_altlocs to accept only those atoms which are not disordered or with an altloc that matches the best altloc for that particular set of atoms.
        """
